...
<body>
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light">
			<a href="${R}shop/index"><img src="/images/22st.png" align="middle"
				style="height: 80px; weight:70px;"></a><a class="navbar-brand"
				style="color: pink; font-family: 'Poor Story', cursive; font-size: 4em; margin-right: 20px;"</a>
